...
function set_locked_state(locked_state){
	let readout = document.getElementById("lock_status");
...
function parse_message(message){
	if( attempt_auto_response(message) == false){
		...
		if(command_type == "clear_config"){
			...
			document.getElementById("config_json").innerHTML = "";
			document.getElementById("mode_json").innerHTML   = "";
			document.getElementById("slider_json").innerHTML = "";
			document.getElementById("toggle_json").innerHTML = "";
			...
			pretty_print_json("configuration", configuration, "config_json");
			pretty_print_json("modes", modes, "mode_json");
			pretty_print_json("sliders", sliders, "slider_json");
			pretty_print_json("toggles", toggles, "toggle_json");
